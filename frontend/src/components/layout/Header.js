              ...
              <div className="navbar-menu">
                  ...
                  <div className="nav-left" >
                    ...
                    <div className="collapse  nav-desk" id="navbarToggleExternalContent">
                      <ul className="nav-cat title-font">
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/01.png" alt="category-product"/> western ware</a></li>
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/02.png" alt="category-product"/> TV, Appliances</a></li>
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/03.png" alt="category-product"/> Pets Products</a></li>
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/04.png" alt="category-product"/> Car, Motorbike</a></li>
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/05.png" alt="category-product"/> Industrial Products</a></li>
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/06.png" alt="category-product"/> Beauty, Health Products</a></li>
                        <li> <a href="category-page(left-sidebar).html"><img src="../../../public/assets/images/layout-1/nav-img/07.png" alt="category-product"/> Grocery Products </a></li>
                ...
                <div className="icon-block">
                  <ul>
                    ...
                    <li className="mobile-user onhover-dropdown"  onclick="openAccount()">
                      <a href="#">
                        {/* <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                          <g>
