  ...
  <div className="custom-container">
    <div className="row collection2">
      ...
      <div className="col-md-4">
        ...
        <div className="col-md-4  ">
          <div className="collection-banner-main p-left  height-equal" style={{minHeight: "235px"}}>
            <div className="collection-img bg-size" style={{backgroundImage: 'url("../assets/images/layout-4/collection-banner/1.jpg")', backgroundSize: "cover", backgroundPosition: "center center", display: "block"}}> <img src="../assets/images/layout-4/collection-banner/1.jpg" className="img-fluid bg-img" alt="banner" style={{display: "none"}}/> </div>
            <div className="collection-banner-contain">
              <div>
                <h3>vivo</h3>
                <h4>smart phone</h4>
                <div className="shop"> <a href="product-page(left-sidebar).html">
                                        shop now
        ...
        <div className="col-md-4  ">
          <div className="collection-banner-main p-left  height-equal" style={{minHeight: "235px"}}>
            <div className="collection-img  bg-size" style={{backgroundImage: 'url("../assets/images/layout-1/collection-banner/2.jpg")', backgroundSize: "cover", backgroundPosition: "center center", display: "block"}}> <img src="../assets/images/layout-1/collection-banner/2.jpg" className="img-fluid bg-img" alt="banner" style={{display: "none"}}/> </div>
            <div className="collection-banner-contain">
              <div>
                <h3>hand</h3>
                <h4>lether bag</h4>
        ...
        <div className="col-md-2 ">
          <div className="collection-banner-main p-left banner-8 height-equal" style={{minHeight: "235px"}}>
            <div className="collection-banner-contain">
              <div>
                <h3>extra</h3>
                <h3>50% off</h3>
...
{/* <!--hot deal start--> */}  
 <section>
      ...
      <div className="row hot-4">
        <div className="col-md-2 pr-lg-0  ">
          <div className="media-banner banner-inverse b-g-white1 border-0 media-banner-2">
            ...
            <div className="media-banner-box">
              <div className="media">
                <a href="product-page(left-sidebar).html" tabIndex="0"> <img src="../assets/images/layout-1/media-banner/1.jpg" className="img-fluid  " alt="banner"/> </a>
                  ...
                  <div className="media-contant">
                    <div>
                      ...
                      <div className="cart-info">
                        <button className="tooltip-top" data-tippy-content="Add to cart" > <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg> </button> <a href="#"  className="add-to-wish tooltip-top"  data-tippy-content="Add to Wishlist" ><i  data-feather="heart" className="add-to-wish"></i></a> <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" className="tooltip-top"  data-tippy-content="Quick View"><i  data-feather="eye"></i></a> <a href="compare.html"  className="tooltip-top" data-tippy-content="Compare"><i  data-feather="refresh-cw"></i></a> </div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="media-banner-box">
              <div className="media">
                <a href="product-page(left-sidebar).html" tabIndex="0"> <img src="../assets/images/layout-1/media-banner/2.jpg" className="img-fluid  " alt="banner"/> </a>
                <div className="media-body">
                  <div className="media-contant">
                    <div>
                      <div className="product-detail">
            ...
            <div className="media-banner-box">
              <div className="media">
                <a href="product-page(left-sidebar).html" tabIndex="0"> <img src="../assets/images/layout-1/media-banner/3.jpg" className="img-fluid  " alt="banner"/> </a>
                <div className="media-body">
                  <div className="media-contant">
                    <div>
                      <div className="product-detail">
            ...
            <div className="media-banner-box">
              <div className="media">
                <a href="product-page(left-sidebar).html" tabIndex="0"> <img src="../assets/images/layout-1/media-banner/4.jpg" className="img-fluid  " alt="banner"/> </a>
                <div className="media-body">
                  <div className="media-contant">
                    <div>
                      <div className="product-detail">
                        ...
                        <div>
                          <a href="product-page(left-sidebar).html">
                            <div className="img-wrraper">
                              <div> <img src="../assets/images/layout-2/hot-deal/8.jpg" alt="hot-deal" className="img-fluid bg-img "/> </div>
                            </div>
                          </a>
                        </div>
                      </div>
                      ...
                      <div className="hotdeal-right-slick">
                        <div>
                          <div>
                            ...
                            <h6>$45.00<span>$50.30</span></h6>
                            <div className="timer">
                              <p id="demo"> </p>
                            </div> <a href="product-page(left-sidebar).html" className="btn btn-normal btn-md">shop now</a> </div>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-2">
                      <div className="hotdeal-right-nav">
                        <div> <img src="../assets/images/layout-2/hot-deal/8.jpg" alt="hot-deal" className="img-fluid  "/> </div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div className="tab-product-main">
      <div className="tab-prodcut-contain">
        <ul className="tabs tab-title">
          <li className="current"><a href="tab-1">fashion</a></li>
          <li className=""><a href="tab-2">electronic</a></li>
  ...
  {/* <section className="section-py-space ratio_square product">
    <div className="custom-container" style={{backgroundColor: "rgba(241, 88, 56, 0.5)"}}>
      <div className="row">
        <div className="col pr-0">
          <div className=" product no-arrow">
                ...
                <div className="product-slide-6 product-m no-arrow">
                  <div>
                    <div className="product-box">
                      <div className="product-imgbox">
                        <div className="product-front">
                          <a href="product-page(left-sidebar).html"> <img src="../assets/images/layout-4/product/8.jpg" className="img-fluid  " alt="product"/> </a>
                        </div>
                        <div className="product-back">
                          <a href="product-page(left-sidebar).html"> <img src="../assets/images/layout-4/product/a8.jpg" className="img-fluid  " alt="product"/> </a>
                        </div>
                        <div className="new-label3">
                          <div>new</div>
                        </div>
                      ...
                      <div className="product-detail detail-center detail-inverse">
                        <div className="detail-title">
                          ...
                          <div className="detail-right">
                            <div className="check-price"> $ 97.21 </div>
                            <div className="price">
                              <div className="price"> $ 84.05 </div>
                            </div>
                          </div>
                        </div>
                        <div className="icon-detail">
...
<section className="product section-pb-space mb--5">
  <div className="custom-container">
    <div className="row">
      <div className="col pr-0">
        <div className="product-slide-6 no-arrow slick-initialized slick-slider"><button className="slick-prev slick-arrow" aria-label="Previous" type="button" style={{display: "inline-block"}}>Previous</button><div className="slick-list draggable"><div className="slick-track" style={{opacity: "1", width: "5358px", transform: "translate3d(-1410px, 0px, 0px)"}}><div className="slick-slide slick-cloned" data-slick-index="-5" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
                    <img src="../assets/images/layout-2/product/4.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-back">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
                    <img src="../assets/images/layout-2/product/a4.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-icon icon-inline">
                  <button  className="tooltip-top" data-tippy-content="Add to cart" tabIndex="-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                  </button>
                  <a href="#" className="add-to-wish tooltip-top" data-tippy-content="Add to Wishlist" tabIndex="-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  </a>
                  <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" className="tooltip-top" data-tippy-content="Quick View" tabIndex="-1">
                  ...
                  <a href="compare.html" className="tooltip-top" data-tippy-content="Compare" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
                    <img src="../assets/images/layout-2/product/5.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-back">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
                    <img src="../assets/images/layout-2/product/a5.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-icon icon-inline">
                  <button  className="tooltip-top" data-tippy-content="Add to cart" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
                    <img src="../assets/images/layout-2/product/7.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-back">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
                    <img src="../assets/images/layout-2/product/a7.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-icon icon-inline">
                  <button  className="tooltip-top" data-tippy-content="Add to cart" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
                    <img src="../assets/images/layout-2/product/1.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-back">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
                    <img src="../assets/images/layout-2/product/a1.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-icon icon-inline">
                  <button  className="tooltip-top" data-tippy-content="Add to cart" tabIndex="0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                  </button>
                  <a href="#" className="add-to-wish tooltip-top" data-tippy-content="Add to Wishlist" tabIndex="0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  </a>
                  <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" className="tooltip-top" data-tippy-content="Quick View" tabIndex="0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                  </a>
          ...
          </div></div></div><div className="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
                    <img src="../assets/images/layout-2/product/2.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-back">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
                    <img src="../assets/images/layout-2/product/a2.jpg" className="img-fluid  " alt="product"/>
                  </a>
                </div>
                <div className="product-icon icon-inline">
                  <button  className="tooltip-top" data-tippy-content="Add to cart" tabIndex="0">
          ...
          </div></div></div><div className="slick-slide slick-active" data-slick-index="2" aria-hidden="false" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
          ...
          </div></div></div><div className="slick-slide slick-active" data-slick-index="3" aria-hidden="false" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
          ...
          </div></div></div><div className="slick-slide slick-active" data-slick-index="4" aria-hidden="false" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="0">
          ...
          </div></div></div><div className="slick-slide" data-slick-index="5" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide" data-slick-index="6" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="7" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="8" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="9" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="10" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="11" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="12" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div><div className="slick-slide slick-cloned" data-slick-index="13" aria-hidden="true" tabIndex="-1" style={{width: "282px"}}><div><div style={{width: "100%", display: "inline-block"}}>
            <div className="product-box">
              <div className="product-imgbox">
                <div className="product-front">
                  <a href="product-page(left-sidebar).html" tabIndex="-1">
          ...
          </div></div></div></div></div><button className="slick-next slick-arrow" aria-label="Next" type="button" style={{display: "inline-block"}}>Next</button></div>
      </div>
    </div>
  </div>
</section>
  ...
  <section className="services ">
    <div className="container">
      <div className="row service-block">
        ...
        <div className="col-lg-3 col-md-6  col-sm-12">
          <div className="media">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" {...attributeElements} x="0px" y="0px" viewBox="0 0 417.12 417.12">
              <g>
                <g>
      ...
      C417.12,204.323,413.538,200.741,409.12,200.741z" /> </g>
              </g>
              <g>
                <g>
      ...
      c2.291-2.379,3.53-5.579,3.44-8.88C204.691,262.051,203.173,258.598,200.4,256.341z" /> </g>
              </g>
              <g>
                <g>
      ...
      c2.877-2.141,4.425-5.63,4.08-9.2C339.301,228.744,337.319,224.811,333.76,222.901z M289.36,220.581h-45.84l45.84-61.92V220.581z" /> </g>
              </g>
            </svg>
            <div className="media-body">
              <h5>24X7 SERVICE</h5> </div>
          </div>
        </div>
        <div className="col-lg-3 col-md-6  col-sm-12 ">
          <div className="media">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 295.82 295.82" {...attributeElements} enableBackground="new 0 0 295.82 295.82">
              <g>
                <g>
                  ...
                  <path d="m151.391,191.413h-106.148c-5.22,0-8.701,3.48-8.701,8.701s3.48,8.701 8.701,8.701h106.147c3.48,0 8.701-3.48 8.701-8.701s-3.48-8.701-8.7-8.701z" /> </g>
              </g>
            </svg>
            <div className="media-body">
              <h5>EASY RETURN</h5> </div>
          </div>
        </div>
        <div className="col-lg-3 col-md-6  col-sm-12 ">
          <div className="media">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" {...attributeElements} x="0px" y="0px" viewBox="0 0 448 448">
              <g>
                <g>
                  <g>
        ...
        c19.2-22,46.8-34.8,76-34.8c7.2,0,14.4,0.8,21.6,2.4c4.4,0.8,8.4-2,9.6-6s-2-8.4-6-9.6C240.8,52.8,232.4,52,224,52z" /> </g>
                </g>
              </g>
            </svg>
            <div className="media-body">
              <h5>ONLINE PAYMENT</h5> </div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="section-pb-space">
    <div className="tab-product-main">
      <div className="tab-prodcut-contain">
        <ul className="tabs tab-title">
          <li className="current"><a href="tab-7">new product</a></li>
          <li className=""><a href="tab-8">Feature Products</a></li>
          <li className=""><a href="tab-9">best Sellers</a></li>
          <li className=""><a href="tab-10">On Sale</a></li>
        </ul>
      </div>
    </div>
  </section>
                            ...
                            <div className="media-contant">
                              <div>
                                ...
                                <div className="cart-info">
                                  ...
                                  <a href="#"  className="add-to-wish tooltip-top"  data-tippy-content="Add to Wishlist" ><i  data-feather="heart" className="add-to-wish"></i></a> 
                                  <a href="#" data-bs-toggle="modal" data-bs-target="#quick-view" className="tooltip-top"  data-tippy-content="Quick View"><i  data-feather="eye"></i></a> 
                                  <a href="compare.html"  className="tooltip-top" data-tippy-content="Compare"><i  data-feather="refresh-cw"></i></a> </div>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <div className="col pl-0">
          <div className="slide-10 no-arrow">
            ...
            <div>
              <a href="category-page(left-sidebar).html">
                <div className="box-category-contain">
                  <h4>extra 10% off</h4> </div>
              </a>
            </div>
            <div>
              <a href="category-page(left-sidebar).html">
                <div className="box-category-contain">
                  <h4>$79 cashback</h4> </div>
              </a>
            </div>
            <div>
              <a href="category-page(left-sidebar).html">
        ...
        <div className="col-md-12 col-lg-4 ">
          <div className="deal-banner-containe">
            <div className="deal-btn">
                 <a href="category-page(left-sidebar).html" className="btn-white">
              View more
            </a> 
            </div>
            </div>
            ...
            <div>
              <div className="category-contain">
                <div className="img-wrapper">
                  <a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/rounded-cat/1.png" alt="category  " className="img-fluid"/> </a>
                </div> <a href="category-page(left-sidebar).html" className="btn-rounded">
                flower
              </a> </div>
            </div>
            <div>
          ...
          <div className="slide-1 no-arrow">
            <div>
              <div className="testimonial-contain">
                <div className="media">
                  <div className="testimonial-img"> <img src="../assets/images/testimonial/1.jpg" className="img-fluid rounded-circle  " alt="testimonial"/> </div>
                  <div className="media-body">
                    <h5>mark jecno</h5>
        ...
        <div className="col">
          <div className="insta-contant2">
            <div className="slide-7 no-arrow">
              <div>
                <div className="instagram-box"> <img src="../assets/images/insta/1.jpg" className="img-fluid  " alt="insta"/>
                  <div className="insta-cover"> <i className="fa fa-instagram"></i> </div>
                </div>
              </div>
            </div>
            <div className="insta-sub-contant2">
              <div className="insta-title">
                <h4><span>#</span>INSTAGRAM</h4> </div>
            </div>
          </div>
        </div>
      </div>
